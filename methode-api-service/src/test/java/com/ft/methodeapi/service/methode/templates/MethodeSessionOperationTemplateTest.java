...
public class MethodeSessionOperationTemplateTest {
    ...
    public void shouldMaybeCloseAllObjectsAfterSuccessfulOperation() {
        MethodeSessionOperationTemplate<Object> sut = new MethodeSessionOperationTemplate<>(mockMethodeObjectFactory);
