...
public class MasterImage {
    ...
    private static final String MASTER_IMAGE_SAMPLE_IMAGE = readFromFile("images/Master_2048x1152/mi-sample-image.jpg");
    private static final String MASTER_IMAGE_ATTRIBUTES_XML = readFromFile("images/Master_2048x1152/mi-sample-attributes.xml");
    private static final String MASTER_IMAGE_SYSTEM_ATTRIBUTES_XML = readFromFile("images/Master_2048x1152/mi-sample-system-attributes.xml");
    private static final String MASTER_IMAGE_USAGE_TICKETS_XML = readFromFile("images/Master_2048x1152/mi-sample-usage-tickets.xml");
